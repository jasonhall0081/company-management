...
import cenglisch.hiring.domain.model.person.event.PersonVerified;
import cenglisch.hiring.domain.model.person.event.PersonalInformationDeposited;
import cenglisch.hiring.domain.model.person.exception.PersonException;
