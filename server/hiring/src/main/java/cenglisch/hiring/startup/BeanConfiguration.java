...
import cenglisch.hiring.port.adapter.secondary.database.candidate.CandidateRepositoryAdapter;
import cenglisch.hiring.port.adapter.secondary.database.interview.InterviewRepositoryAdapter;
import cenglisch.hiring.port.adapter.secondary.database.job.JobRepositoryAdapter;
import cenglisch.hiring.port.adapter.secondary.database.person.PersonRepositoryAdapter;
